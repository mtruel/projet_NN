...
def export(ls: float, nvert: int, nfiles: int) -> None:
    ...
    and creates a label file with the list of files, size of contours, number of inner verticies generated by gmsh"
    ...
    for k in range(nfiles):
        ...
        f = open("exports/export"+str(k)+".dat", "w+")
